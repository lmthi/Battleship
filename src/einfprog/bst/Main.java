...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        /*/
        IPlayer player2 = new ManualPlayer();
        player2.init(new Random(random.nextLong()));
        //*/

        player1.onMatchStart(player2.getName(), 1, BoardType.STANDARD_BOARD);
        player2.onMatchStart(player1.getName(), 1, BoardType.STANDARD_BOARD);

        GameManager m = new GameManager(BoardType.STANDARD_BOARD, ShipType.STANDARD_SHIPS, player1, player2);
